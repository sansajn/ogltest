...
int main(int argc, char * argv[])
{
	...
	glm::mat4 P = glm::perspective(glm::radians(70.0f), 800.0f/600.0f, 0.1f, 100.0f);
	...
	GLint local_to_screen_loc = glGetUniformLocation(prog, "local_to_screen");
	assert(local_to_screen_loc != -1 && "unknown uniform");
	glUniformMatrix4fv(local_to_screen_loc, 1, GL_FALSE, glm::value_ptr(local_to_screen));
	assert(glGetError() == GL_NO_ERROR);

...
void display()
{	
	offscreen_tex->bind_as_render_target();
...
int main(int argc, char * argv[])
{
	...
	bricks = new texture("assets/textures/bricks.png");
	bricks_n = new texture("assets/textures/bricks_n.png");
	bricks_h = new texture("assets/textures/bricks_h.png");
	...
	offscreen_tex = new texture();
	offscreen_tex->create(texw, texh);

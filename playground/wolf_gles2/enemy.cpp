...
string const death1 = "assets/sound/death1.ogg";
string const death2 = "assets/sound/death2.ogg";
string const machine_gun = "assets/sound/machine_gun.ogg";
...
enemy_object::enemy_object(btVector3 const & position)
{
	...
	string files[] = {
		...
		"assets/textures/sswva1.png",  // 1: run
		"assets/textures/sswvb1.png",
		"assets/textures/sswvc1.png",
		"assets/textures/sswvd1.png",
		"assets/textures/sswve0.png",  // 5: shooting
		"assets/textures/sswvf0.png",
		"assets/textures/sswvg0.png",
		"assets/textures/sswvh0.png",
		"assets/textures/sswvi0.png",  // 9: death
		"assets/textures/sswvj0.png",
		"assets/textures/sswvk0.png",
		"assets/textures/sswvl0.png",
		"assets/textures/sswvm0.png"  // 13
	};

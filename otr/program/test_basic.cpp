// k vykresleniu objektu použije program
#include <string>
#include <cassert>
#include <iostream>
...
char const * vs_src = "layout(location=0) in vec3 position;\n\
...
int main(int argc, char * argv[])
{
	...
	ptr<shader::module> simple_modules(new shader::module(330, vs_src, fs_src));
	...
	ptr<uniform_matrix4f> mvp_u = prog.get_uniform<uniform_matrix4f>("mvp");
	mvp_u->set_matrix(MVP);
